...
/**
 * 생성 근거 전송 DTO(quiz-set/api). AIProblem의 rationale을 저장 계층으로 전달하는 중간 표현이며, ProblemMapper에서 엔티티
 * Rationale로 변환된다. 객관형은 selfChecks를, 서술형(ESSAY)은 modelAnswerBasis·rubricConsistency를 채우며 해당 없는 필드는
 * null이다.
 */
public record RationaleOfAI(
