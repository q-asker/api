...
/** REAL_BLANK 퀴즈 전용 유저 프롬프트. Remember/Understand 2수준. 1청크 단일 호출. */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public class RealBlankRequestPrompt {

  /** 청크 K(K≥2) 유저 프롬프트 꼬리에 붙는 중복 회피 지침. */
  public static final String DEDUP_INSTRUCTION =
      "\n\n> **CRITICAL RULE**: 위 직전 문항 목록과 핵심 정답 어휘·맥락이 겹치지 않게 이번 청크 문항을 작성한다."
          + " stemSummary와 동일·유사한 맥락은 다른 단원·다른 페이지에서 가져와 재구성한다.";
