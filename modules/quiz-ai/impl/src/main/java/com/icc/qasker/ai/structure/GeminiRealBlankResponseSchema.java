...
/** REAL_BLANK 전용 JSON 스키마. customInstruction 유무에 따라 appliedInstruction 필드를 포함/제외한다. */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public class GeminiRealBlankResponseSchema {

  private static final String WITH_INSTRUCTION =
      new BeanOutputConverter<>(GeminiRealBlankResponse.class).getJsonSchema();
